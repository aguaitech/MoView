...
export function usePresenceDetector(settings) {
    ...
    const [matchedSafeIds, setMatchedSafeIds] = useState([]);
    const [error, setError] = useState(null);
    const sendPresence = (hasVisitorFlag, confidenceScore, safeFlag, movement, matches) => {
    ...
    const registerSafeFace = async (label) => {
